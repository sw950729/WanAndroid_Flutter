...
class HomeArticleListEntity {
  int curPage;
  List<HomeArticleListDatasEntity> datas;
  int offset;
  bool over;
  int pageCount;
  int size;
  ...
  HomeArticleListEntity.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      datas = new List<HomeArticleListDatasEntity>();
      json['datas'].forEach((v) {
        datas.add(new HomeArticleListDatasEntity.fromJson(v));
      });
    }
    offset = json['offset'];
    over = json['over'];
...
class HomeArticleListDatasEntity {
  String apkLink;
  int audit;
  String author;
  int chapterId;
  ...
  HomeArticleListDatasEntity.fromJson(Map<String, dynamic> json) {
